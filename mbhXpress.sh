...
# of each one against the other to get the mutual best hits
...
do
	...
	t) THREADS=${OPTARG};;
	h) echo "mbhXpress v1.2.1 - usage :";
	   echo "-a PROTEOME1";
	   echo "-b PROTEOME2";
	   echo "-o OUTPUT_NAME";
	   echo "-t THREADS";
	   exit;;
	?) echo "mbhXpress v1.2.1 - usage :";
	   echo "-a PROTEOME1";
	   echo "-b PROTEOM2";
	   echo "-o OUTPUT_NAME";
	   echo "-t THREADS";
...
echo "             mbhXpress v1.2.1" | tee -a $OUTPUT_NAME.log
echo "---------------------------------------------" | tee -a $OUTPUT_NAME.log
...
echo " - select the mutual best hits" | tee -a $OUTPUT_NAME.log
...
echo "---------------------------------------------" | tee -a $OUTPUT_NAME.log
echo "   Done : found $amount_mbh mutual best hits." | tee -a $OUTPUT_NAME.log
